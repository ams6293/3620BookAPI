...
from bookshelf.views import BookViewSet, FantasyViewSet, ComedyViewSet, DramaViewSet, AdventureViewSet, ComingofAgeViewSet, RomanceViewSet, HistoricalFictionViewSet, HorrorViewSet, HistoryViewSet, NonFictionViewSet
from django.conf.urls.static import static
from django.conf import settings

router = routers.SimpleRouter()
router.register('bookshelf', BookViewSet)
...
router.register('comingofage', ComingofAgeViewSet)
